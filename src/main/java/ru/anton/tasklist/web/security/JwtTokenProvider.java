...
import ru.anton.tasklist.domain.exception.AccessDeniedException;
...
import ru.anton.tasklist.service.props.JwtProperties;
...
//Обеспечивает создание токенов, проверку и взаимодействие с токенами
@Service
...
public class JwtTokenProvider {
    ...
    public String createAccessToken(Long userId, String username, Set<Role> roles) {
        //Claims хранит информацию о пользователе в самом токене
